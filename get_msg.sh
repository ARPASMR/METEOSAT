...
# GPM: in caso di necessità (es.eumetsat cambia MSG3 con MSG1, o viceversa) modificare opportunamente le righe sotto:
mv $MSGDIR_IN/H-000-MSG3__-MSG3*$dataora* $MSGDIR_OT
#cp $MSGDIR_IN/H-000-MSG3__-MSG3*$dataora* $MSGDIR_OT
cp -v $MSGDIR_EPI/H-000-MSG3__-MSG3*$dataora* $MSGDIR_OT
cp -v $MSGDIR_PRO/H-000-MSG3__-MSG3*$dataora* $MSGDIR_OT
